...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			dd = element("dd");
    			t = text(t_value);
    			attr_dev(dd, "class", "svelte-1vfiyx3");
    			add_location(dd, file$2, 32, 10, 738);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*card*/ 1 && t_value !== (t_value = /*name*/ ctx[12] + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(32:8) {#each card.name as name}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let dt1;
    	let dd0;
    	let t2_value = /*card*/ ctx[0].cost + "";
    	let t2;
    	let dt2;
    	let dd1;
    	let t4_value = /*card*/ ctx[0].createCost + "";
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			dt1 = element("dt");
    			dt1.textContent = "基礎コスト";
    			dd0 = element("dd");
    			t2 = text(t2_value);
    			dt2 = element("dt");
    			dt2.textContent = "作成コスト";
    			dd1 = element("dd");
    			t4 = text(t4_value);
    			add_location(dt0, file$2, 30, 8, 680);
    			add_location(dt1, file$2, 34, 8, 780);
    			attr_dev(dd0, "class", "svelte-1vfiyx3");
    			add_location(dd0, file$2, 35, 8, 804);
    			add_location(dt2, file$2, 36, 8, 834);
    			attr_dev(dd1, "class", "svelte-1vfiyx3");
    			add_location(dd1, file$2, 37, 8, 858);
    			attr_dev(dl, "class", "svelte-1vfiyx3");
    			add_location(dl, file$2, 29, 6, 666);
    			attr_dev(div0, "class", "card svelte-1vfiyx3");
    			add_location(div0, file$2, 28, 4, 640);
    			attr_dev(div1, "class", "card-div svelte-1vfiyx3");
    			add_location(div1, file$2, 27, 2, 612);
    			attr_dev(div2, "class", "card-wrap svelte-1vfiyx3");
    			set_style(div2, "grid-column", /*gridColumnStart*/ ctx[5] + " / " + /*gridColumnEnd*/ ctx[6]);
    			set_style(div2, "grid-row-start", /*gridRow*/ ctx[7]);
    			...
    			toggle_class(div2, "columnEven", /*columnEven*/ ctx[9]);
    			toggle_class(div2, "rowEven", /*rowEven*/ ctx[8]);
    			add_location(div2, file$2, 17, 0, 381);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*card*/ 1 && t2_value !== (t2_value = /*card*/ ctx[0].cost + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*card*/ 1 && t4_value !== (t4_value = /*card*/ ctx[0].createCost + "")) set_data_dev(t4, t4_value);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('rowIdx' in $$props) $$invalidate(10, rowIdx = $$props.rowIdx);
    		if ('columnIdx' in $$props) $$invalidate(11, columnIdx = $$props.columnIdx);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('rowIdx' in $$props) $$invalidate(10, rowIdx = $$props.rowIdx);
    		if ('columnIdx' in $$props) $$invalidate(11, columnIdx = $$props.columnIdx);
    		if ('gridColumnStart' in $$props) $$invalidate(5, gridColumnStart = $$props.gridColumnStart);
    		if ('gridColumnEnd' in $$props) $$invalidate(6, gridColumnEnd = $$props.gridColumnEnd);
    		if ('gridRow' in $$props) $$invalidate(7, gridRow = $$props.gridRow);
    		if ('rowEven' in $$props) $$invalidate(8, rowEven = $$props.rowEven);
    		if ('columnEven' in $$props) $$invalidate(9, columnEven = $$props.columnEven);
    	};
    ...
    class CardComponent extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*rowIdx*/ ctx[10] === undefined && !('rowIdx' in props)) {
    			console.warn("<CardComponent> was created without expected prop 'rowIdx'");
    		}

    		if (/*columnIdx*/ ctx[11] === undefined && !('columnIdx' in props)) {
    ...
    // (119:6) {#if rowIdx < tmpList.length - 1}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(119:6) {#if rowIdx < tmpList.length - 1}",
    		ctx
    	});
    ...
    // (125:4) {#each row as card, columnIdx}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(125:4) {#each row as card, columnIdx}",
    		ctx
    	});
    ...
    // (114:2) {#each tmpList as row, rowIdx}
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*rowIdx*/ ctx[9] < /*tmpList*/ ctx[0].length - 1) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(span, "class", "count " + (/*rowIdx*/ ctx[9] % 2 === 0 ? 'even' : '') + " svelte-16r1j68");
    			set_style(span, "grid-row-start", /*rowIdx*/ ctx[9] + 1);
    			add_location(span, file$1, 114, 4, 3318);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(114:2) {#each tmpList as row, rowIdx}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 111, 0, 3196);
    			attr_dev(div1, "class", "grid svelte-16r1j68");
    			set_style(div1, "--count", /*gridColumn*/ ctx[2]);
    			add_location(div1, file$1, 112, 0, 3231);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('gridColumn' in $$props) $$invalidate(2, gridColumn = $$props.gridColumn);
    	};
    	...
    	return [tmpList, totalCreateCost, gridColumn, items];
    }

    class CardListComponent extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { items: 3 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-18ghg7h");
    			add_location(main, file, 19, 0, 346);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
